...
REM 检查MySQL安装目录是否存在
if not exist "e:\melon\apps\MySQL\mysql-8.1.0-winx64\bin" (
...
REM 注册MySQL服务
@REM e:\melon\apps\MySQL\mysql-8.1.0-winx64\bin\mysqld.exe --install MySQL_protable --defaults-file=d:\melon\apps\MySQL\mysql-8.1.0-winx64\my.ini
e:\melon\apps\MySQL\mysql-8.1.0-winx64\bin\mysqld.exe --install MySQL_protable
